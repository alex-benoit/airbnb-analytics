...
class FlatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create flat' do
    assert_difference('Flat.count') do
      post flats_url, params: { flat: { description: @flat.description, lat: @flat.lat, lng: @flat.lng, location: @flat.location, name: @flat.name, photo_url: @flat.photo_url, price: @flat.price } }
    end
  ...
  test 'should update flat' do
    patch flat_url(@flat), params: { flat: { description: @flat.description, lat: @flat.lat, lng: @flat.lng, location: @flat.location, name: @flat.name, photo_url: @flat.photo_url, price: @flat.price } }
